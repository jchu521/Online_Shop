    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model )
        {
            if (ModelState.IsValid)
            {
                ...
                //add 17-08-17 membership
                var roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(context));
                var role = new IdentityRole();
                //if (model.isPremiun)
                //{
                //    role.Name = "Full Member";
                //}
                //else
                //{
                //    role.Name = "Associate";
                ...
                if (result.Succeeded)
                {
                    ...
                    /*110917 - register becomes associate 
                     * 
                     * 17-08-17 member either associate or full member
                     */
                    UserManager.AddToRoles(user.Id, "Associate");

                    //end
                    /* 110917 
                     * remove this part and now the member can not become full member in the 
                     * register page need to go to manage index page to join the club
                     * 
                     *  020917 
                     *  add new account expiry date (1 year)
